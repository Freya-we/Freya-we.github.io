...
export const siteConfig: SiteConfig = {
	title: "Freya's Blog",
	subtitle: "CTF、Web 安全与技术实践笔记",
	siteURL: "https://freya-we.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: "/assets/freya/banner.jpg", // 桌面横幅图片
			mobile: "/assets/freya/banner.jpg", // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			subtitle: [
				"CTF player. Security learner. Notes from practice.",
				"记录 CTF、Web 安全与每一次技术实践",
				"保持好奇，持续学习",
				"从复现到理解，从记录到成长",
